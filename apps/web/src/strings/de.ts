export const de = {
  ...
  history: {
    ...
    eventTypes: {
      ...
      RANDOMLY_ASSIGNED: 'Zufallszuweisung an {member}',
      ASSIGNMENT_ACCEPTED: '{member} hat die zugeloste Aufgabe übernommen',
      ...
      CONSTRAINT_RELAXED: 'Regel ausgesetzt: {constraint}',
      NO_ELIGIBLE_CANDIDATES: 'Keine geeigneten Kandidaten',
      PAUSED: 'Aufgabe pausiert',
      RESUMED: 'Aufgabe fortgesetzt',
      POINTS_CLAWED_BACK: '{member} hat {points} Punkte zurückgegeben',
